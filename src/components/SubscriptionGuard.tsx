...
const CONFIG = {
    ...
    DEFAULT_FEATURE_SLUG: 'tanda-terima'
};
...
// =========================================
export const clearSubscriptionSession = (featureSlug: string = 'tanda-terima') => {
...
// =========================================
export const hasSubscriptionSession = (featureSlug: string = 'tanda-terima'): boolean => {
    try {
